...
any other geom, the use of grouping, multiple insets per panel,
faceting with different tables per panel, and different number of insets in each
...
possible to add annotations to plots consistently across data sets and varying
scales used.
...
to the labeled observations or points by a line segment or arrow. However,
...
currently provide two different, and flexible nudge functions described in
